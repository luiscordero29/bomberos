...
Class Documentos_5_model extends CI_MODEL
{
	...
	function table($limit,$start,$search)
	{
	    ...
	    $this->db->where('tipo_documento','REPORTE_INCENDIO_FORESTAL_VEGETACION');
	...
	function create()
	{
		...
		$fecha 					= date(implode('-', $date_array));
	   	...
	   	$terreno_direccion 				= $this->input->post('terreno_direccion');
	   	$terreno_tipo 					= $this->input->post('terreno_tipo');
	   	$terreno_propietario 			= $this->input->post('terreno_propietario');
	   	$terreno_vegetacion 			= $this->input->post('terreno_vegetacion');
	   	$terreno_topografia 			= $this->input->post('terreno_topografia');
	   	$terreno_area 					= $this->input->post('terreno_area');
	   	$terreno_cortafuego 			= $this->input->post('terreno_cortafuego');
	   	$terreno_largo 					= $this->input->post('terreno_largo');
	   	$terreno_ancho 					= $this->input->post('terreno_ancho');
	   	$terreno_natural 				= $this->input->post('terreno_natural');
	   	$terreno_artificial 			= $this->input->post('terreno_artificial');
	   	$terreno_oc_agua 				= $this->input->post('terreno_oc_agua');
	   	$terreno_oc_agua_cantidad 		= $this->input->post('terreno_oc_agua_cantidad');
	   	$terreno_oc_espuma 				= $this->input->post('terreno_oc_espuma');
	   	$terreno_oc_espuma_cantidad 	= $this->input->post('terreno_oc_espuma_cantidad');
	   	...
	   	$data = array(
		   	...
		   	'terreno_direccion' 				=> $terreno_direccion, 
		   	'terreno_tipo' 						=> $terreno_tipo, 
		   	'terreno_propietario' 				=> $terreno_propietario, 
		   	'terreno_vegetacion' 				=> $terreno_vegetacion, 
		   	'terreno_topografia' 				=> $terreno_topografia, 
		   	'terreno_area' 						=> $terreno_area, 
		   	'terreno_cortafuego' 				=> $terreno_cortafuego, 
		   	'terreno_largo' 					=> $terreno_largo, 
		   	'terreno_ancho' 					=> $terreno_ancho, 
		   	'terreno_natural' 					=> $terreno_natural, 
		   	'terreno_artificial' 				=> $terreno_artificial, 		   	
		   	'terreno_oc_agua' 					=> $terreno_oc_agua,
		   	'terreno_oc_agua_cantidad' 			=> $terreno_oc_agua_cantidad, 
		   	'terreno_oc_espuma' 				=> $terreno_oc_espuma, 
		   	'terreno_oc_espuma_cantidad' 		=> $terreno_oc_espuma_cantidad, 
		);
