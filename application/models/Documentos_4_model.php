...
Class Documentos_4_model extends CI_MODEL
{
	...
	function table($limit,$start,$search)
	{
	    ...
	    $this->db->where('tipo_documento','REPORTE_INCENDIO_VEHICULAR');
	...
	function create()
	{
		...
		$fecha 					= date(implode('-', $date_array));
	   	...
	   	$vehiculo_oc_materiales 			= $this->input->post('vehiculo_oc_materiales');
	   	$vehiculo_oc_tecnicas 				= $this->input->post('vehiculo_oc_tecnicas');
	   	$vehiculo_oc_zonas 					= $this->input->post('vehiculo_oc_zonas');
	   	$n_lesionados 						= $this->input->post('n_lesionados');
	   	$n_fallecidos 						= $this->input->post('n_fallecidos');
	   	$vehiculo_oc_agua 					= $this->input->post('vehiculo_oc_agua');
	   	$vehiculo_oc_agua_cantidad 			= $this->input->post('vehiculo_oc_agua_cantidad');
	   	$vehiculo_oc_espuma 				= $this->input->post('vehiculo_oc_espuma');
	   	$vehiculo_oc_espuma_cantidad 		= $this->input->post('vehiculo_oc_espuma_cantidad');
	   	$vehiculo_oc_extintor 				= $this->input->post('vehiculo_oc_extintor');
	   	$vehiculo_oc_extintor_cantidad 		= $this->input->post('vehiculo_oc_extintor_cantidad');
	   	...
	   	$data = array(
		   	...
		   	'vehiculo_oc_materiales' 			=> $vehiculo_oc_materiales, 
		   	'vehiculo_oc_tecnicas' 				=> $vehiculo_oc_tecnicas, 
		   	'vehiculo_oc_zonas' 				=> $vehiculo_oc_zonas, 
		   	'n_lesionados' 						=> $n_lesionados, 
		   	'n_fallecidos' 						=> $n_fallecidos, 
		   	'vehiculo_oc_agua' 					=> $vehiculo_oc_agua,
		   	'vehiculo_oc_agua_cantidad' 		=> $vehiculo_oc_agua_cantidad, 
		   	'vehiculo_oc_espuma' 				=> $vehiculo_oc_espuma, 
		   	'vehiculo_oc_espuma_cantidad' 		=> $vehiculo_oc_espuma_cantidad, 
		   	'vehiculo_oc_extintor' 				=> $vehiculo_oc_extintor, 
		   	'vehiculo_oc_extintor_cantidad' 	=> $vehiculo_oc_extintor_cantidad, 
		);
