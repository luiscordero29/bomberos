...
Class Documentos_3_model extends CI_MODEL
{
	...
	function table($limit,$start,$search)
	{
	    ...
	    $this->db->where('tipo_documento','REPORTE_INCENDIO_ESTRUCTURA');
	...
	function create()
	{
		...
		$fecha 					= date(implode('-', $date_array));
	   	...
	   	$inmueble_propietario 				= $this->input->post('inmueble_propietario');
	   	$inmueble_propietario_identidad 	= $this->input->post('inmueble_propietario_identidad');
	   	$inmueble_propietario_edad 			= $this->input->post('inmueble_propietario_edad');
	   	$inmueble_tipo_estructura 			= $this->input->post('inmueble_tipo_estructura');
	   	$inmueble_oc_forma_entrada 			= $this->input->post('inmueble_oc_forma_entrada');
	   	$inmueble_oc_materiales 			= $this->input->post('inmueble_oc_materiales');
	   	$inmueble_oc_tecnicas 				= $this->input->post('inmueble_oc_tecnicas');
	   	$inmueble_oc_zonas 					= $this->input->post('inmueble_oc_zonas');
	   	$n_lesionados 						= $this->input->post('n_lesionados');
	   	$n_fallecidos 						= $this->input->post('n_fallecidos');
	   	$inmueble_oc_agua 					= $this->input->post('inmueble_oc_agua');
	   	$inmueble_oc_agua_cantidad 			= $this->input->post('inmueble_oc_agua_cantidad');
	   	$inmueble_oc_espuma 				= $this->input->post('inmueble_oc_espuma');
	   	$inmueble_oc_espuma_cantidad 		= $this->input->post('inmueble_oc_espuma_cantidad');
	   	$inmueble_oc_extintor 				= $this->input->post('inmueble_oc_extintor');
	   	$inmueble_oc_extintor_cantidad 		= $this->input->post('inmueble_oc_extintor_cantidad');
	   	...
	   	$data = array(
		   	...
		   	'inmueble_propietario_identidad' 	=> $inmueble_propietario_identidad, 
		   	'inmueble_propietario_edad' 		=> $inmueble_propietario_edad, 
		   	'inmueble_tipo_estructura' 			=> $inmueble_tipo_estructura, 
		   	'inmueble_oc_forma_entrada' 		=> $inmueble_oc_forma_entrada, 
		   	'inmueble_oc_materiales' 			=> $inmueble_oc_materiales, 
		   	'inmueble_oc_tecnicas' 				=> $inmueble_oc_tecnicas, 
		   	'inmueble_oc_zonas' 				=> $inmueble_oc_zonas, 
		   	'n_lesionados' 						=> $n_lesionados, 
		   	'n_fallecidos' 						=> $n_fallecidos, 
		   	'inmueble_oc_agua' 					=> $inmueble_oc_agua,
		   	'inmueble_oc_agua_cantidad' 		=> $inmueble_oc_agua_cantidad, 
		   	'inmueble_oc_espuma' 				=> $inmueble_oc_espuma, 
		   	'inmueble_oc_espuma_cantidad' 		=> $inmueble_oc_espuma_cantidad, 
		   	'inmueble_oc_extintor' 				=> $inmueble_oc_extintor, 
		   	'inmueble_oc_extintor_cantidad' 	=> $inmueble_oc_extintor_cantidad, 
		);
