...
class Documentos_6 extends CI_Controller {

	/**
	 * Documentos_6
	 **/

	public $controller = "documentos_6";
	...
	public function __construct()
	{
		...
		$this->load->model('Documentos_6_model','',TRUE);
	...
	public function index($table_page=null,$id=null,$search=null)
	{
		$data['breadcrumbs'] = 
			array(
	            ...
	            '<i class="fa fa-fw fa-table"></i> Servicio Especial'			=> '',        	
	        );
		...
		$data['table'] = $this->Documentos_6_model->table($table_page*$table_limit,$table_limit,$data['search']);
		$data['table_rows'] = $this->Documentos_6_model->table_rows($data['search']);
	...
	public function create()
	{
		$data['breadcrumbs'] = 
			array(
	            '<i class="fa fa-fw fa-home"></i> Tablero Principal'			=> 'dashboard/index',
	            '<i class="fa fa-fw fa-table"></i> Servicio Especial'			=> $this->controller.'/index',
		...
		$data['table_estados'] = $this->Documentos_6_model->table_estados();
		...
		{				
			...
			$this->Documentos_6_model->create();
	...
	{			
		...
		if($this->form_validation->run() == FALSE)
		{
			...
			$data['row'] = $this->Documentos_6_model->read($id);
			if(empty($data['row']))
			{
				$data['alert']['danger'] = 
						array( 
			...
			$this->Documentos_6_model->update();
			$data['alert']['success'] = 
				array( 
					'Guardado Exitosamente',				
				);
	...
	public function delete($id=false)
	{
		...
		$check = $this->Documentos_6_model->delete($id);
		if($check)
		{
		    $data['alert']['success'] = 
			array( 
    ...
    {	     	
	    ...
	    $rows = $this->Documentos_6_model->table_municipios($id_estado);
    ...
    {	     	
	    ...
	    $rows = $this->Documentos_6_model->table_parroquias($id_municipio);
