...
class Documentos_4 extends CI_Controller {

	/**
	 * Documentos_4
	 **/

	public $controller = "documentos_4";
	...
	public function __construct()
	{
		...
		$this->load->model('Documentos_4_model','',TRUE);
	...
	public function index($table_page=null,$id=null,$search=null)
	{
		$data['breadcrumbs'] = 
			array(
	            ...
	            '<i class="fa fa-fw fa-table"></i> Incendios Vehiculares'			=> '',        	
	        );
		...
		$data['table'] = $this->Documentos_4_model->table($table_page*$table_limit,$table_limit,$data['search']);
		$data['table_rows'] = $this->Documentos_4_model->table_rows($data['search']);
	...
	public function create()
	{
		$data['breadcrumbs'] = 
			array(
	            '<i class="fa fa-fw fa-home"></i> Tablero Principal'			=> 'dashboard/index',
	            '<i class="fa fa-fw fa-table"></i> Incendios Vehiculares'			=> $this->controller.'/index',
		...
		$this->form_validation->set_rules('vehiculo_oc_materiales', 'Materiales en Combustión', 'trim|required');
		$this->form_validation->set_rules('vehiculo_oc_tecnicas', 'Técnicas Aplicadas', 'trim|required');
		$this->form_validation->set_rules('vehiculo_oc_zonas', 'Zonas Afectadas', 'trim|required');
		...
		$this->form_validation->set_rules('vehiculo_oc_agua', 'Agua', 'trim|required');
		$this->form_validation->set_rules('vehiculo_oc_agua_cantidad', 'Cantidad de Agua', 'trim|required|numeric');
		$this->form_validation->set_rules('vehiculo_oc_espuma', 'Espuma', 'trim|required');
		$this->form_validation->set_rules('vehiculo_oc_espuma_cantidad', 'Cantidad de Espuma', 'trim|required|numeric');
		$this->form_validation->set_rules('vehiculo_oc_extintor', 'Extintor', 'trim|required');
		$this->form_validation->set_rules('vehiculo_oc_extintor_cantidad', 'Cantidad de Extintor', 'trim|required|numeric');
		...
		$data['table_estados'] = $this->Documentos_4_model->table_estados();
		...
		{				
			...
			$this->Documentos_4_model->create();
	...
	{			
		...
		if($this->form_validation->run() == FALSE)
		{
			...
			$data['row'] = $this->Documentos_4_model->read($id);
			if(empty($data['row']))
			{
				$data['alert']['danger'] = 
						array( 
			...
			$this->Documentos_4_model->update();
			$data['alert']['success'] = 
				array( 
					'Guardado Exitosamente',				
				);
	...
	public function delete($id=false)
	{
		...
		$check = $this->Documentos_4_model->delete($id);
		if($check)
		{
		    $data['alert']['success'] = 
			array( 
    ...
    {	     	
	    ...
	    $rows = $this->Documentos_4_model->table_municipios($id_estado);
    ...
    {	     	
	    ...
	    $rows = $this->Documentos_4_model->table_parroquias($id_municipio);
