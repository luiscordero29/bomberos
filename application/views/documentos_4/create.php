    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h1 class="page-header"><i class="fa fa-fw fa-file-text-o"></i> Crear Registro [Incendios Vehiculares]</h1>
                ...
                <div class="col-sm-12">                       
                    ...
                    <div class="row">                        
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="vehiculo_oc_materiales" id="vehiculo_oc_materiales" class="form-control" required>
                        </div>
                        <div class="col-sm-12">
                            <label for="vehiculo_oc_tecnicas">Técnicas Aplicadas:</label>
                            <input type="text" name="vehiculo_oc_tecnicas" id="vehiculo_oc_tecnicas" class="form-control" required>
                        </div>
                        <div class="col-sm-12">
                            <label for="vehiculo_oc_zonas">Zonas Afectadas:</label>
                            <input type="text" name="vehiculo_oc_zonas" id="vehiculo_oc_zonas" class="form-control" required>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="vehiculo_oc_agua_cantidad" id="vehiculo_oc_agua_cantidad" class="form-control" maxlength="30">
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="vehiculo_oc_espuma_cantidad" id="vehiculo_oc_espuma_cantidad" class="form-control" maxlength="30">
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="vehiculo_oc_extintor_cantidad" id="vehiculo_oc_extintor_cantidad" class="form-control" maxlength="30">
                        </div>
