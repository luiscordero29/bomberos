  ...
  <head>
    ...
    <title>
        <?php if ($this->uri->segment(2) == 'create'): ?>  
          Crear Incendio Vehiculare - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS “MAYOR (B) (†) EVERARDO LEÓN TORRES”
        <?php elseif ($this->uri->segment(2) == 'update'): ?>  
          Editar Incendio Vehiculare - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS “MAYOR (B) (†) EVERARDO LEÓN TORRES”
        <?php elseif ($this->uri->segment(2) == 'delete'): ?>  
          Eliminar Incendio Vehiculare - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS “MAYOR (B) (†) EVERARDO LEÓN TORRES”
        <?php else: ?>  
          Tabla de Incendios Vehiculares - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS “MAYOR (B) (†) EVERARDO LEÓN TORRES”
        <?php endif ?>
    </title>
