    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h1 class="page-header"><i class="fa fa-fw fa-edit"></i> Editar Registro [Incendios Vehiculares]</h1>
        ...
        <div>
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation"><a href="#formulario4" aria-controls="formulario4" role="tab" data-toggle="tab">Operaci&oacute;n</a></li>
            </ul>
            ...
            <div role="tabpanel" class="tab-pane" id="formulario4">
                ...
                <div class="col-sm-12">                       
                    ...
                    <div class="row">                        
                        ...
                        <div class="col-sm-12">
                            <label for="vehiculo_oc_materiales">Materiales en Combustión:</label>
                            <input type="text" name="vehiculo_oc_materiales" id="vehiculo_oc_materiales" class="form-control" required value="<?php echo $row['vehiculo_oc_materiales']; ?>">
                        </div>
                        <div class="col-sm-12">
                            <label for="vehiculo_oc_tecnicas">Técnicas Aplicadas:</label>
                            <input type="text" name="vehiculo_oc_tecnicas" id="vehiculo_oc_tecnicas" class="form-control" required value="<?php echo $row['vehiculo_oc_tecnicas']; ?>">
                        </div>
                        <div class="col-sm-12">
                            <label for="vehiculo_oc_zonas">Zonas Afectadas:</label>
                            <input type="text" name="vehiculo_oc_zonas" id="vehiculo_oc_zonas" class="form-control" required value="<?php echo $row['vehiculo_oc_zonas']; ?>">
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <label for="vehiculo_oc_agua">Agua:</label>
                            <select name="vehiculo_oc_agua" id="vehiculo_oc_agua" class="form-control" required>
                                <option value="">SELECCIONE</option>
                                <option <?php if($row['vehiculo_oc_agua']=='NO'){ echo 'selected'; } ?> value="NO">NO</option>
                                <option <?php if($row['vehiculo_oc_agua']=='SI'){ echo 'selected'; } ?> value="SI">SI</option>
                            </select>
                        </div>
                        <div class="col-sm-6">
                            <label for="vehiculo_oc_agua_cantidad">Cantidad de Agua:</label>
                            <input type="text" name="vehiculo_oc_agua_cantidad" id="vehiculo_oc_agua_cantidad" class="form-control" maxlength="30" value="<?php echo $row['vehiculo_oc_agua_cantidad']; ?>">
                        </div>
                        <div class="col-sm-6">
                            <label for="vehiculo_oc_espuma">Espuma:</label>
                            <select name="vehiculo_oc_espuma" id="vehiculo_oc_espuma" class="form-control" required>
                                <option value="">SELECCIONE</option>
                                <option <?php if($row['vehiculo_oc_espuma']=='NO'){ echo 'selected'; } ?> value="NO">NO</option>
                                <option <?php if($row['vehiculo_oc_espuma']=='SI'){ echo 'selected'; } ?> value="SI">SI</option>
                            </select>
                        </div>
                        <div class="col-sm-6">
                            <label for="vehiculo_oc_espuma_cantidad">Cantidad de Espuma:</label>
                            <input type="text" name="vehiculo_oc_espuma_cantidad" id="vehiculo_oc_espuma_cantidad" class="form-control" maxlength="30" value="<?php echo $row['vehiculo_oc_espuma_cantidad']; ?>">
                        </div>
                        <div class="col-sm-6">
                            <label for="vehiculo_oc_extintor">Extintor:</label>
                            <select name="vehiculo_oc_extintor" id="vehiculo_oc_extintor" class="form-control" required>
                                <option value="">SELECCIONE</option>
                                <option <?php if($row['vehiculo_oc_extintor']=='NO'){ echo 'selected'; } ?> value="NO">NO</option>
                                <option <?php if($row['vehiculo_oc_extintor']=='SI'){ echo 'selected'; } ?> value="SI">SI</option>
                            </select>
                        </div>
                        <div class="col-sm-6">
                            <label for="vehiculo_oc_extintor_cantidad">Cantidad de Extintor:</label>
                            <input type="text" name="vehiculo_oc_extintor_cantidad" id="vehiculo_oc_extintor_cantidad" class="form-control" maxlength="30" value="<?php echo $row['vehiculo_oc_extintor_cantidad']; ?>">
                        </div>
            ...
            <input type="hidden" name="tipo_documento" value="REPORTE_INCENDIO_VEHICULAR">
            <?php 
                echo form_close(); 
            ?>
