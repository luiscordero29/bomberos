    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h1 class="page-header"><i class="icon icon-table"></i> Servicios de Ambulancias</h1>
                ...
                <?php if($table){ ?>
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $r['paciente_apellidos'].' '.$r['paciente_nombres']; ?></td>
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu" role="menu">
                              <li><a target="_get" href="<?php echo site_url('pdf/documento_2/'.$r['id_documento']); ?>"><span class="icon icon-print"></span> Imprimir</a></li>
