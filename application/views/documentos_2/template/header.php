  ...
  <head>
    ...
    <title>
        <?php if ($this->uri->segment(2) == 'create'): ?>  
          Crear Servicio de Ambulancia - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS “MAYOR (B) (†) EVERARDO LEÓN TORRES”
        <?php elseif ($this->uri->segment(2) == 'update'): ?>  
          Editar Servicio de Ambulancia - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS “MAYOR (B) (†) EVERARDO LEÓN TORRES”
        <?php elseif ($this->uri->segment(2) == 'delete'): ?>  
          Eliminar Servicio de Ambulancia - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS “MAYOR (B) (†) EVERARDO LEÓN TORRES”
        <?php else: ?>  
          Tabla de Servicios de Ambulancias - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS “MAYOR (B) (†) EVERARDO LEÓN TORRES”
        <?php endif ?>
    </title>
