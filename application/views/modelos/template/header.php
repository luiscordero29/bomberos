  ...
  <head>
    ...
    <title>
        <?php if ($this->uri->segment(2) == 'create'): ?>  
          Crear Modelo - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php elseif ($this->uri->segment(2) == 'update'): ?>  
          Editar Modelo - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php elseif ($this->uri->segment(2) == 'delete'): ?>  
          Eliminar Modelo - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php else: ?>  
          Tabla de Modelos - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php endif ?>
    </title>
