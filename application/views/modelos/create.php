    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h1 class="page-header"><i class="fa fa-fw fa-file-text-o"></i> Crear Registro [Tabla de Marcas]</h1>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <select id="id_marca" name="id_marca" class="form-control" autofocus required>
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="modelo" id="modelo" class="form-control" maxlength="255" required >
                        </div>                                                               
                    </div>
                    </fieldset>   
                </div>  
