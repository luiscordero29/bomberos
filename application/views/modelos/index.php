    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h1 class="page-header"><i class="fa fa-fw fa-table"></i> Tabla de Modelos</h1>
                      ...
                      <tr>
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu" role="menu">
                              <li><a href="<?php echo site_url($this->controller.'/update/'.$r['id_modelo']); ?>"><span class="fa fa-fw fa-edit"></span> Editar</a></li>
                              <li><a href="<?php echo site_url($this->controller.'/delete/'.$r['id_modelo']); ?>"><span class="fa fa-fw fa-trash"></span> Eliminar</a></li>                              
                          </ul>
                        </div>
