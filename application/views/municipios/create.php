                ...
                <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <select id="id_estado" name="id_estado" class="form-control" autofocus required>
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="municipio" id="municipio" class="form-control" maxlength="255" required >
                        </div>                                                               
                    </div>
                    </fieldset>   
                </div>  
