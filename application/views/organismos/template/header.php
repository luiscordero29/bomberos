  ...
  <head>
    ...
    <title>
        <?php if ($this->uri->segment(2) == 'create'): ?>  
          Crear Organismo - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php elseif ($this->uri->segment(2) == 'update'): ?>  
          Editar Organismo - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php elseif ($this->uri->segment(2) == 'delete'): ?>  
          Eliminar Organismo - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php else: ?>  
          Tabla de Organismos - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php endif ?>
    </title>
