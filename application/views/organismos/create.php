    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h1 class="page-header"><i class="icon icon-file-text-o"></i> Crear Registro [Organismos Actuantes en el Servicio]</h1>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="unidad" id="unidad" class="form-control" maxlength="255" autofocus>
                        </div> 
                        <div class="col-sm-12">
                            <label for="dependencia">Dependencia:</label>
                            <input type="text" name="dependencia" id="dependencia" class="form-control" maxlength="255" required>
                        </div>                                                               
                        <div class="col-sm-12">
                            <label for="cp">Conducida Por:</label>
                            <input type="text" name="cp" id="cp" class="form-control" maxlength="255">
                        </div> 
                        <div class="col-sm-12">
                            <label for="am">Al Mando:</label>
                            <input type="text" name="am" id="am" class="form-control" maxlength="255">
                        </div> 
                    </div>
                    </fieldset>   
                </div>  
