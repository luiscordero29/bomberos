    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h1 class="page-header"><i class="fa fa-fw fa-file-text-o"></i> Eliminar Registro [Tabla de Colores]</h1>
            ...
            <div>
                ...
                <div class="col-sm-12">
                    ...
                    <a href="<?php echo site_url($this->controller.'/index/'.$row_documento['id_documento']); ?>" class="btn btn-default"><i class="fa fa-fw fa-arrow-left"></i> Volver</a>             
