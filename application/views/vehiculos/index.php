    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h1 class="page-header"><i class="icon icon-folder-open"></i> Vehiculos Involucrados</h1>
                ...
                <?php if($table){ ?>
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $r['propietario_identidad']; ?></td>
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu" role="menu">
                              <li><a href="<?php echo site_url($this->controller.'/update/'.$row_documento['id_documento'].'/'.$r['id_vehiculo']); ?>"><span class="icon icon-edit"></span> Editar</a></li>
                              <li><a href="<?php echo site_url($this->controller.'/delete/'.$row_documento['id_documento'].'/'.$r['id_vehiculo']); ?>"><span class="icon icon-trash"></span> Eliminar</a></li>                              
                          </ul>
                        </div>
