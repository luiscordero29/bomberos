    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h1 class="page-header"><i class="fa fa-fw fa-file-text-o"></i> Crear Registro [Guardia de Seguridad Prevención]</h1>
        ...
        <div>
                ...
                <div class="col-sm-12">                       
                    ...
                    <div class="row">                        
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="text" name="servicio_tipo" id="servicio_tipo" class="form-control" required maxlength="255">
                        </div>
                        <div class="col-sm-12">
                            <label for="servicio_motivacion">Motivado a:</label>
                            <input type="text" name="servicio_motivacion" id="servicio_motivacion" class="form-control" required maxlength="255">
                        </div>
                        <div class="col-sm-12">
                            <label for="servicio_direccion">Dirección:</label>
                            <input type="text" name="servicio_direccion" id="servicio_direccion" class="form-control" required maxlength="255">
                        </div>
                        <div class="col-sm-12">
                            <label for="servicio_persona">Nombre y Apellido:</label>
                            <input type="text" name="servicio_persona" id="servicio_persona" class="form-control" required maxlength="255">
                        </div>
                        <div class="col-sm-4">
                            <label for="servicio_persona_edad">Edad:</label>
                            <input type="text" name="servicio_persona_edad" id="servicio_persona_edad" class="form-control" required maxlength="3">
                        </div>
                        <div class="col-sm-4">
                            <label for="servicio_persona_identidad">C.I:</label>
                            <input type="text" name="servicio_persona_identidad" id="servicio_persona_identidad" class="form-control" required maxlength="15">
                        </div>
                        <div class="col-sm-4">
                            <label for="servicio_persona_telefono">Tel&eacute;fono:</label>
                            <input type="text" name="servicio_persona_telefono" id="servicio_persona_telefono" class="form-control" maxlength="30">
                        </div>  
                        <div class="col-sm-12">
                            <label for="servicio_materiales">Materiales Utilizados:</label>
                            <input type="text" name="servicio_materiales" id="servicio_materiales" class="form-control">
                        </div>
            ...
            <input type="hidden" name="tipo_documento" value="REPORTE_GUARDIA">
            <?php 
                echo form_close(); 
            ?>
