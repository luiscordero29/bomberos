    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h1 class="page-header"><i class="icon icon-table"></i> Guardia de Seguridad Prevenciónl</h1>
                ...
                <?php if($table){ ?>
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $r['servicio_tipo']; ?></td>
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu" role="menu">
                              <li><a target="_get" href="<?php echo site_url('pdf/documento_7/'.$r['id_documento']); ?>"><span class="icon icon-print"></span> Imprimir</a></li>
