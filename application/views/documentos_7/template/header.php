  ...
  <head>
    ...
    <title>
        <?php if ($this->uri->segment(2) == 'create'): ?>  
          Crear Guardia de Seguridad Prevención - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS “MAYOR (B) (†) EVERARDO LEÓN TORRES”
        <?php elseif ($this->uri->segment(2) == 'update'): ?>  
          Editar Guardia de Seguridad Prevención - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS “MAYOR (B) (†) EVERARDO LEÓN TORRES”
        <?php elseif ($this->uri->segment(2) == 'delete'): ?>  
          Eliminar Guardia de Seguridad Prevención - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS “MAYOR (B) (†) EVERARDO LEÓN TORRES”
        <?php else: ?>  
          Tabla de Guardia de Seguridad Prevención - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS “MAYOR (B) (†) EVERARDO LEÓN TORRES”
        <?php endif ?>
    </title>
