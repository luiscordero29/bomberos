    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h1 class="page-header"><i class="fa fa-fw fa-edit"></i> Editar Registro [Tabla de Estados]</h1>
        ...
        <div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="estado" id="estado" class="form-control" maxlength="255" required autofocus value="<?php echo $row['estado']; ?>">
                        </div>                                                               
                    </div>
                    </fieldset>   
                </div>  
            ...
            <input type="hidden" name="id_estado" value="<?php echo $row['id_estado'] ?>">
            <?php 
                echo form_close(); 
            ?>
