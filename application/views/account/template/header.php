  ...
  <head>
    ...
    <title>
        <?php if ($this->uri->segment(2) == 'profile'): ?>  
          Editar Datos - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php elseif ($this->uri->segment(2) == 'password'): ?>  
          Cambiar Clave - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php elseif ($this->uri->segment(2) == 'index'): ?>  
          Informaci&oacute;n - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php else: ?> 
          Informaci&oacute;n de la Cuenta - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php endif ?>
