  ...
  <head>
    ...
    <title>
        <?php if ($this->uri->segment(2) == 'create'): ?>  
          Crear Parroquia - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php elseif ($this->uri->segment(2) == 'update'): ?>  
          Editar Parroquia - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php elseif ($this->uri->segment(2) == 'delete'): ?>  
          Eliminar Parroquia - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php else: ?>  
          Tabla de Parroquias - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php endif ?>
    </title>
