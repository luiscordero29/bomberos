    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h1 class="page-header"><i class="fa fa-fw fa-edit"></i> Editar Registro [Tabla de Parroquias]</h1>
        ...
        <div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <select id="id_estado" name="id_estado" class="form-control" required autofocus onchange="ajax_Parroquias_table_municipios()">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="parroquia" id="parroquia" class="form-control" maxlength="255" required value="<?php echo $row['parroquia']; ?>">
                        </div>                                                               
                    </div>
                    </fieldset>   
                </div>  
            ...
            <input type="hidden" name="id_parroquia" value="<?php echo $row['id_parroquia'] ?>">
            <?php 
                echo form_close(); 
            ?>
