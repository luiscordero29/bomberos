    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h1 class="page-header"><i class="fa fa-fw fa-edit"></i> Editar Registro [Incendios de Estructuras]</h1>
                ...
                <div class="col-sm-12">                       
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="tipo_suceso" id="tipo_suceso" class="form-control" maxlength="255" required value="<?php echo $row['tipo_suceso']; ?>">
                        </div>
                ...
                <div class="col-sm-12">                       
                    ...
                    <div class="row">                        
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="inmueble_direccion" id="inmueble_direccion" class="form-control" maxlength="255" required value="<?php echo $row['inmueble_direccion']; ?>">
                        </div> 
                        <div class="col-sm-12">
                            <label for="inmueble_propietario">Propietario:</label>
                            <input type="text" name="inmueble_propietario" id="inmueble_propietario" class="form-control" maxlength="255" required value="<?php echo $row['inmueble_propietario']; ?>">
                        </div> 
                        <div class="col-sm-6">
                            <label for="inmueble_propietario_identidad">Cedula de Identidad:</label>
                            <input type="text" name="inmueble_propietario_identidad" id="inmueble_propietario_identidad" class="form-control" maxlength="15" required value="<?php echo $row['inmueble_propietario_identidad']; ?>">
                        </div> 
                        <div class="col-sm-6">
                            <label for="inmueble_propietario_edad">Edad:</label>
                            <input type="text" name="inmueble_propietario_edad" id="inmueble_propietario_edad" class="form-control" maxlength="3" required value="<?php echo $row['inmueble_propietario_edad']; ?>">
                        </div>
                        <div class="col-sm-12">
                            <label for="inmueble_tipo_estructura">Tipo de Estructura:</label>
                            <input type="text" name="inmueble_tipo_estructura" id="inmueble_tipo_estructura" class="form-control" maxlength="255" required value="<?php echo $row['inmueble_tipo_estructura']; ?>">
                        </div>
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="inmueble_oc_forma_entrada" id="inmueble_oc_forma_entrada" class="form-control" maxlength="255" required value="<?php echo $row['inmueble_oc_forma_entrada']; ?>">
                        </div>
                        <div class="col-sm-12">
                            <label for="inmueble_oc_materiales">Materiales en Combustión:</label>
                            <input type="text" name="inmueble_oc_materiales" id="inmueble_oc_materiales" class="form-control" required value="<?php echo $row['inmueble_oc_materiales']; ?>">
                        </div>
                        <div class="col-sm-12">
                            <label for="inmueble_oc_tecnicas">Técnicas Aplicadas:</label>
                            <input type="text" name="inmueble_oc_tecnicas" id="inmueble_oc_tecnicas" class="form-control" required value="<?php echo $row['inmueble_oc_tecnicas']; ?>">
                        </div>
                        <div class="col-sm-12">
                            <label for="inmueble_oc_zonas">Zonas Afectadas:</label>
                            <input type="text" name="inmueble_oc_zonas" id="inmueble_oc_zonas" class="form-control" required value="<?php echo $row['inmueble_oc_zonas']; ?>">
                        </div>
                        <div class="col-sm-6">
                            <label for="n_lesionados">Número de Lesionados:</label>
                            <input type="text" name="n_lesionados" id="n_lesionados" class="form-control" maxlength="20" required value="<?php echo $row['n_lesionados']; ?>">
                        </div>  
                        <div class="col-sm-6">
                            <label for="n_fallecidos">Número de Fallecidos:</label>
                            <input type="text" name="n_fallecidos" id="n_fallecidos" class="form-control" maxlength="20" required value="<?php echo $row['n_fallecidos']; ?>">
                        </div>
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="inmueble_oc_agua" id="inmueble_oc_agua" class="form-control" required>
                                <option value="">SELECCIONE</option>
                                <option <?php if($row['inmueble_oc_agua']=='NO'){ echo 'selected'; } ?> value="NO">NO</option>
                                <option <?php if($row['inmueble_oc_agua']=='SI'){ echo 'selected'; } ?> value="SI">SI</option>
                            </select>
                        </div>
                        <div class="col-sm-6">
                            <label for="inmueble_oc_agua_cantidad">Cantidad de Agua:</label>
                            <input type="text" name="inmueble_oc_agua_cantidad" id="inmueble_oc_agua_cantidad" class="form-control" maxlength="30" value="<?php echo $row['inmueble_oc_agua_cantidad']; ?>">
                        </div>
                        <div class="col-sm-6">
                            ...
                            <select name="inmueble_oc_espuma" id="inmueble_oc_espuma" class="form-control" required>
                                <option value="">SELECCIONE</option>
                                <option <?php if($row['inmueble_oc_espuma']=='NO'){ echo 'selected'; } ?> value="NO">NO</option>
                                <option <?php if($row['inmueble_oc_espuma']=='SI'){ echo 'selected'; } ?> value="SI">SI</option>
                            </select>
                        </div>
                        <div class="col-sm-6">
                            <label for="inmueble_oc_espuma_cantidad">Cantidad de Espuma:</label>
                            <input type="text" name="inmueble_oc_espuma_cantidad" id="inmueble_oc_espuma_cantidad" class="form-control" maxlength="30" value="<?php echo $row['inmueble_oc_espuma_cantidad']; ?>">
                        </div>
                        <div class="col-sm-6">
                            ...
                            <select name="inmueble_oc_extintor" id="inmueble_oc_extintor" class="form-control" required>
                                <option value="">SELECCIONE</option>
                                <option <?php if($row['inmueble_oc_extintor']=='NO'){ echo 'selected'; } ?> value="NO">NO</option>
                                <option <?php if($row['inmueble_oc_extintor']=='SI'){ echo 'selected'; } ?> value="SI">SI</option>
                            </select>
                        </div>
                        <div class="col-sm-6">
                            <label for="inmueble_oc_extintor_cantidad">Cantidad de Extintor:</label>
                            <input type="text" name="inmueble_oc_extintor_cantidad" id="inmueble_oc_extintor_cantidad" class="form-control" maxlength="30" value="<?php echo $row['inmueble_oc_extintor_cantidad']; ?>">
                        </div>
