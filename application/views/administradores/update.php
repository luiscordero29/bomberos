                ...
                <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" name="usuario" id="usuario" class="form-control" maxlength="15" required autofocus value="<?php echo $row['usuario']; ?>">
                                    </div> 
                                    <div class="col-sm-6">
                                        <label for="identidad">Cedula de Identidad:</label>
                                        <input type="text" name="identidad" id="identidad" class="form-control" maxlength="10" required value="<?php echo $row['identidad']; ?>" >
                                    </div>                                 
                                </div>
