    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h1 class="page-header"><i class="fa fa-fw fa-file-text-o"></i> Crear Registro [Accidentes de Transitos]</h1>
                ...
                <div class="col-sm-12">                      
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="sitio_suceso" id="sitio_suceso" class="form-control" maxlength="255" required>
                        </div> 
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="uvir_tipo" id="uvir_tipo" class="form-control">
                                <option value="">SELECCIONE</option>
                                <option value="EXTRICACION">EXTRICACION</option>
                                <option value="PREVENCION">PREVENCION</option>
                                <option value="ACTO DE PRESENCIA">ACTO DE PRESENCIA</option>
                            </select>
                        </div> 

                        <div class="col-sm-12">
                            <label for="uamb">Unidad/Ambulancia:</label>
                            <input type="text" name="uamb" id="uamb" class="form-control" maxlength="255">
                        </div> 
                        <div class="col-sm-12">
                            <label for="uamb_cp">Conducida Por:</label>
                            <input type="text" name="uamb_cp" id="uamb_cp" class="form-control" maxlength="255">
                        </div> 
                        <div class="col-sm-12">
