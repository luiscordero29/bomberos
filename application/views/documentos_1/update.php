    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h1 class="page-header"><i class="fa fa-fw fa-edit"></i> Editar Registro [Accidentes de Transitos]</h1>
        ...
        <div>
            ...
            <!-- Nav tabs -->
             <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation"><a href="#formulario3" aria-controls="formulario3" role="tab" data-toggle="tab">Lugar</a></li>
                <li role="presentation"><a href="#formulario4" aria-controls="formulario4" role="tab" data-toggle="tab">Transporte</a></li>
            </ul>
            ...
            <div role="tabpanel" class="tab-pane" id="formulario3">
                ...
                <div class="col-sm-12">                      
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <label for="sitio_suceso">Sitio del Suceso:</label>
                            <input type="text" name="sitio_suceso" id="sitio_suceso" class="form-control" maxlength="255" required value="<?php echo $row['sitio_suceso']; ?>">
                        </div> 
                        <div class="col-sm-6">
            ...
            <div role="tabpanel" class="tab-pane" id="formulario4">
                ...
                <div class="col-sm-12">                       
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <label for="uvir_tipo">Tipo:</label>
                            <select name="uvir_tipo" id="uvir_tipo" class="form-control">
                                <option value="">SELECCIONE</option>
                                <option <?php if($row['uvir_tipo']=='EXTRICACION'){ echo 'selected'; } ?> value="EXTRICACION">EXTRICACION</option>
                                <option <?php if($row['uvir_tipo']=='PREVENCION'){ echo 'selected'; } ?> value="PREVENCION">PREVENCION</option>
                                <option <?php if($row['uvir_tipo']=='ACTO DE PRESENCIA'){ echo 'selected'; } ?> value="ACTO DE PRESENCIA">ACTO DE PRESENCIA</option>
                            </select>
                        </div> 
            ...
            <input type="hidden" name="tipo_documento" value="REPORTE_ACCIDENTE_TRANSITO">
            <?php 
                echo form_close(); 
            ?>
