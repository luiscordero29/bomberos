    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h1 class="page-header"><i class="fa fa-fw fa-edit"></i> Editar Registro [Incendios Forestal y Vegetación]</h1>
                ...
                <div class="col-sm-12">                       
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="text" name="terreno_direccion" id="terreno_direccion" class="form-control" required value="<?php echo $row['terreno_direccion']; ?>">
                        </div>
                        <div class="col-sm-3">
                            <label for="terreno_tipo">Tipo:</label>
                            <select name="terreno_tipo" id="terreno_tipo" class="form-control" required>
                                <option value="">SELECCIONE</option>
                                <option <?php if($row['terreno_tipo']=='BALDIO'){ echo 'selected'; } ?> value="BALDIO">BALDIO</option>
                                <option <?php if($row['terreno_tipo']=='EJIDO'){ echo 'selected'; } ?> value="EJIDO">EJIDO</option>
                                <option <?php if($row['terreno_tipo']=='PRIVADO'){ echo 'selected'; } ?> value="PRIVADO">PRIVADO</option>
                            </select>
                        </div>
                        <div class="col-sm-12">
                            <label for="terreno_propietario">Propietario:</label>
                            <input type="text" name="terreno_propietario" id="terreno_propietario" class="form-control" value="<?php echo $row['terreno_propietario']; ?>">
                        </div>
                        <div class="col-sm-12">
                            <label for="terreno_vegetacion">Tipo de Vegetación:</label>
                            <input type="text" name="terreno_vegetacion" id="terreno_vegetacion" class="form-control" value="<?php echo $row['terreno_vegetacion']; ?>">
                        </div>
                        <div class="col-sm-12">
                            <label for="terreno_topografia">Topografía del Terreno:</label>
                            <input type="text" name="terreno_topografia" id="terreno_topografia" class="form-control" value="<?php echo $row['terreno_topografia']; ?>">
                        </div>
                        <div class="col-sm-12">
                            <label for="terreno_area">Área afectada:</label>
                            <input type="text" name="terreno_area" id="terreno_area" class="form-control" value="<?php echo $row['terreno_area']; ?>">
                        </div>
                        <div class="col-sm-3">
                            <label for="terreno_cortafuego">Corta Fuego:</label>
                            <input type="text" name="terreno_cortafuego" id="terreno_cortafuego" class="form-control" value="<?php echo $row['terreno_cortafuego']; ?>">
                        </div>
                        <div class="col-sm-3">
                            <label for="terreno_largo">Largo:</label>
                            <input type="text" name="terreno_largo" id="terreno_largo" class="form-control" maxlength="20" value="<?php echo $row['terreno_largo']; ?>">
                        </div>  
                        <div class="col-sm-3">
                            <label for="terreno_ancho">Ancho:</label>
                            <input type="text" name="terreno_ancho" id="terreno_ancho" class="form-control" maxlength="20" value="<?php echo $row['terreno_ancho']; ?>">
                        </div>
                        <div class="col-sm-3">
                            <label for="terreno_natural">Natural:</label>
                            <input type="text" name="terreno_natural" id="terreno_natural" class="form-control" maxlength="20" value="<?php echo $row['terreno_natural']; ?>">
                        </div>
                        <div class="col-sm-3">
                            <label for="terreno_artificial">Artificial:</label>
                            <input type="text" name="terreno_artificial" id="terreno_artificial" class="form-control" maxlength="20" value="<?php echo $row['terreno_artificial']; ?>">
                        </div>
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="terreno_oc_agua" id="terreno_oc_agua" class="form-control" required>
                                <option value="">SELECCIONE</option>
                                <option <?php if($row['terreno_oc_agua']=='NO'){ echo 'selected'; } ?> value="NO">NO</option>
                                <option <?php if($row['terreno_oc_agua']=='SI'){ echo 'selected'; } ?> value="SI">SI</option>
                            </select>
                        </div>
                        <div class="col-sm-6">
                            <label for="terreno_oc_agua_cantidad">Cantidad de Agua:</label>
                            <input type="text" name="terreno_oc_agua_cantidad" id="terreno_oc_agua_cantidad" class="form-control" maxlength="30" value="<?php echo $row['terreno_oc_agua_cantidad']; ?>">
                        </div>
                        <div class="col-sm-6">
                            <label for="terreno_oc_espuma">Espuma:</label>
                            <select name="terreno_oc_espuma" id="terreno_oc_espuma" class="form-control" required>
                                <option value="">SELECCIONE</option>
                                <option <?php if($row['terreno_oc_espuma']=='NO'){ echo 'selected'; } ?> value="NO">NO</option>
                                <option <?php if($row['terreno_oc_espuma']=='SI'){ echo 'selected'; } ?> value="SI">SI</option>
                            </select>
                        </div>
                        <div class="col-sm-6">
                            <label for="terreno_oc_espuma_cantidad">Cantidad de Espuma:</label>
                            <input type="text" name="terreno_oc_espuma_cantidad" id="terreno_oc_espuma_cantidad" class="form-control" maxlength="30" value="<?php echo $row['terreno_oc_espuma_cantidad']; ?>">
                        </div>
