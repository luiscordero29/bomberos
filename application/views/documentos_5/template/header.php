  ...
  <head>
    ...
    <title>
        <?php if ($this->uri->segment(2) == 'create'): ?>  
          Crear Incendios Forestal y Vegetación - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS “MAYOR (B) (†) EVERARDO LEÓN TORRES”
        <?php elseif ($this->uri->segment(2) == 'update'): ?>  
          Editar Incendios Forestal y Vegetación - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS “MAYOR (B) (†) EVERARDO LEÓN TORRES”
        <?php elseif ($this->uri->segment(2) == 'delete'): ?>  
          Eliminar Incendios Forestal y Vegetación - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS “MAYOR (B) (†) EVERARDO LEÓN TORRES”
        <?php else: ?>  
          Tabla de Incendios Forestal y Vegetación - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS “MAYOR (B) (†) EVERARDO LEÓN TORRES”
        <?php endif ?>
    </title>
