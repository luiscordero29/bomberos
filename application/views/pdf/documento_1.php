...
$obj_pdf->Ln(5);
$obj_pdf->Cell(0, 0, 'Reporte Accidente Transito ', 0, 1, 'C', 0, '', 0,  0, '', 0);
$obj_pdf->Ln(5);
...
$obj_pdf->Cell(0, 0, $r['uvir_tipo'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Ln(5);
...
$obj_pdf->Cell(0, 0, 'Sitio del Suceso: '.$r['sitio_suceso'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Tipo del Suceso: '.$r['tipo_suceso'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(90, 0, 'Nº de Lesionados: '.$r['n_lesionados'], 1, 0, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Nº de Fallecidos: '.$r['n_fallecidos'], 1, 1, 'L', 0, '', 0,  0, '', 0);
