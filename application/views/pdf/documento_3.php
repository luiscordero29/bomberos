...
$obj_pdf->Ln(5);
$obj_pdf->Cell(0, 0, 'Reporte  Incendio de Estructura', 0, 1, 'C', 0, '', 0,  0, '', 0);
$obj_pdf->Ln(5);
...
$obj_pdf->Cell(0, 0, 'Tipo de Suceso: '.$r['tipo_suceso'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Ln(5);
$obj_pdf->SetFont('helvetica', 'B', 9);
$obj_pdf->Cell(0, 0, 'Datos del Inmueble', 1, 1, 'C', 0, '', 0,  0, '', 0);
$obj_pdf->SetFont('helvetica', '', 9);
$obj_pdf->Cell(0, 0, 'Dirección: '.$r['inmueble_direccion'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Propietario: '.$r['inmueble_propietario'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(90, 0, 'C.I.: '.$r['inmueble_propietario_identidad'], 1, 0, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Edad: '.$r['inmueble_propietario_edad'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Tipo de Estructura: '.$r['inmueble_tipo_estructura'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Ln(5);
$obj_pdf->Cell(0, 0, 'Datos de Operación de Combate', 1, 1, 'C', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Forma de Entrada: '.$r['inmueble_oc_forma_entrada'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Materiales en Combustión: '.$r['inmueble_oc_materiales'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Técnicas Aplicadas: '.$r['inmueble_oc_tecnicas'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Zonas Afectadas: '.$r['inmueble_oc_zonas'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(90, 0, 'Número de Lesionados: '.$r['n_lesionados'], 1, 0, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Número de Fallecidos: '.$r['n_fallecidos'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Ln(5);
$obj_pdf->Cell(0, 0, 'Material Utilizado', 1, 1, 'C', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(90, 0, 'Agua: '.$r['inmueble_oc_agua'], 1, 0, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Cantidad de Agua: '.$r['inmueble_oc_agua_cantidad'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(90, 0, 'Espuma: '.$r['inmueble_oc_espuma'], 1, 0, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Cantidad de Espuma: '.$r['inmueble_oc_espuma_cantidad'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(90, 0, 'Extintor: '.$r['inmueble_oc_extintor'], 1, 0, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Cantidad de Extintor: '.$r['inmueble_oc_extintor_cantidad'], 1, 1, 'L', 0, '', 0,  0, '', 0);
