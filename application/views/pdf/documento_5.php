...
$obj_pdf->Ln(5);
$obj_pdf->Cell(0, 0, 'Reporte  Incendio Forestal y Vegetación', 0, 1, 'C', 0, '', 0,  0, '', 0);
$obj_pdf->Ln(5);
...
$obj_pdf->Ln(5);
$obj_pdf->Cell(0, 0, 'Datos del Terreno ', 1, 1, 'C', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Dirección '.$r['terreno_direccion'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Tipo: '.$r['terreno_tipo'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Propietario: '.$r['terreno_propietario'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Tipo de Vegetación: '.$r['terreno_vegetacion'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Topografía del Terreno: '.$r['terreno_topografia'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Área afectada: '.$r['terreno_area'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(60, 0, 'Corta Fuego: '.$r['terreno_cortafuego'], 1, 0, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(60, 0, 'Largo: '.$r['terreno_largo'], 1, 0, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Ancho: '.$r['terreno_ancho'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(90, 0, 'Natural: '.$r['terreno_natural'], 1, 0, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Artificial: '.$r['terreno_artificial'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Ln(5);
$obj_pdf->Cell(0, 0, 'Material Utilizado', 1, 1, 'C', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(90, 0, 'Agua: '.$r['terreno_oc_agua'], 1, 0, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Cantidad de Agua: '.$r['terreno_oc_agua_cantidad'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(90, 0, 'Espuma: '.$r['terreno_oc_espuma'], 1, 0, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Cantidad de Espuma: '.$r['terreno_oc_espuma_cantidad'], 1, 1, 'L', 0, '', 0,  0, '', 0);
