...
$obj_pdf->Ln(5);
$obj_pdf->Cell(0, 0, 'Reporte de Incendio Vehicular', 0, 1, 'C', 0, '', 0,  0, '', 0);
$obj_pdf->Ln(5);
...
$obj_pdf->Cell(0, 0, 'Materiales en Combustión: '.$r['vehiculo_oc_materiales'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Técnicas Aplicadas: '.$r['vehiculo_oc_tecnicas'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Zonas Afectadas: '.$r['vehiculo_oc_zonas'], 1, 1, 'L', 0, '', 0,  0, '', 0);
...
$obj_pdf->Cell(90, 0, 'Agua: '.$r['vehiculo_oc_agua'], 1, 0, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Cantidad de Agua: '.$r['vehiculo_oc_agua_cantidad'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(90, 0, 'Espuma: '.$r['vehiculo_oc_espuma'], 1, 0, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Cantidad de Espuma: '.$r['vehiculo_oc_espuma_cantidad'], 1, 1, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(90, 0, 'Extintor: '.$r['vehiculo_oc_extintor'], 1, 0, 'L', 0, '', 0,  0, '', 0);
$obj_pdf->Cell(0, 0, 'Cantidad de Extintor: '.$r['vehiculo_oc_extintor_cantidad'], 1, 1, 'L', 0, '', 0,  0, '', 0);
