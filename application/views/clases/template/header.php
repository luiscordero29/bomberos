  ...
  <head>
    ...
    <title>
        <?php if ($this->uri->segment(2) == 'create'): ?>  
          Crear Clase - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php elseif ($this->uri->segment(2) == 'update'): ?>  
          Editar Clase - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php elseif ($this->uri->segment(2) == 'delete'): ?>  
          Eliminar Clase - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php else: ?>  
          Tabla de Clases - CUERPO DE BOMBEROS Y BOMBERAS UNIVERSITARIOS "MAYOR (B) (†) EVERARDO LEÓN TORRES"
        <?php endif ?>
    </title>
